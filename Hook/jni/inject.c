...
int main(int argc, char** argv) {
    ...
    inject_remote_process(target_pid, "/data/local/tmp/libmystrcmp.so", "hook_entry",  "I‘m parameter!", strlen("I‘m parameter!"));
    return 0;
}
...
//    }
//    //target_pid = find_pid_of("/data/test");
//    inject_remote_process(target_pid, "/data/libhello1.so", "hook_entry",  "I'm parameter!", strlen("I'm parameter!"));
//    return 0;
//}
