...
public class MyApplication extends Application {
	...
	protected void attachBaseContext(Context base) {
		...
		deleteCacheFile(base, odexPath);
		
		 RefInvoke.setFieldOjbect("android.app.LoadedApk", "mClassLoader",
		 wr.get(), dLoader);
	}
	
	private void deleteCacheFile(Context base, String dirPath){
		File file = new File(dirPath + "/mycode.dex");
		if(file.exists()){
			file.delete();
		}
		File fileJar = new File(dirPath + "/mycode.jar");
		if(fileJar.exists()){
			fileJar.delete();
		}
	}
